...
class Game
{
	public:
		...
		*/
		...
		// void playerResetQuestTracker(uint32_t playerId, const std::vector<uint16_t>& missionIds); // disabled on downgrade
		...
		// void updatePodium(Item* item); // disabled on downgrade
