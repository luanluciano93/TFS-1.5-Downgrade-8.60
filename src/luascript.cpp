...
void LuaScriptInterface::registerFunctions()
{
	...
	// registerEnum(ITEM_TYPE_PODIUM) // disabled on downgrade
	...
	// registerEnum(ITEM_GROUP_PODIUM) // disabled on downgrade
	...
	*/
	...
	// registerMethod("Game", "getMountIdByLookType", LuaScriptInterface::luaGameGetMountIdByLookType); // disabled on downgrade
	...
	*/
	...
	// registerMethod("Player", "sendEditPodium", LuaScriptInterface::luaPlayerSendEditPodium); // disabled on downgrade
			...
			if (g_config.getBoolean(ConfigManager::CONVERT_UNSAFE_SCRIPTS)) {
				for (const auto& entry : indexes) {
					switch (entry.second) {
						...
						case LuaData_Container:
						case LuaData_Teleport: {
						// case LuaData_Podium: { // disabled on downgrade
